...
- JW does not have any financial or personal relationships with Microsoft, OpenAI, or Anthropic that could influence the content of this presentation.
:::
...
- Introduction to agentic coding assistants (e.g., GitHub Copilot, Claude Code)
    - Local review and validation of code (slash Commands and prompts)
