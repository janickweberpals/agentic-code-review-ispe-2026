...
- **Operational Transparency**: Uses style guides and detailed documentation to [ensure analytic decisions are clear, consistent, and easily traceable by others]{style="color: #B22222;"}
- **Cultural Shift**: Normalizes error-finding as a group problem-solving exercise, moving the field toward a [collective "culture of reproducibility"]{style="color: #B22222;"} rather than individual perfection
...
-   Verifies that [analytic code matches the pre-specified study design/protocol]{style="color: #B22222;"}
...
## Code Review - Demo \[placeholder\]

PLACEHOLDER

## Code Review - Automating Validation
...
- [**`testthat`**]{style="color: #B22222;"} is not limited to package development — it can automate validation in any applied analytical study
...
![AI coding agents are LLM-based software programs that autonomously perform coding tasks through natural language interactions](images/ai_coding_agent_architecture.png){width="95%"}
...
-   🗂️ **External Information** — additional external context such as software packages used or common data model concepts (e.g., via MCP servers)
:::
:::::
...
- Supports [**slash commands**]{style="color: #B22222;"} and custom [**skills**]{style="color: #B22222;"}, including [code review workflows]{style="color: #B22222;"}
- Customizable to a specific user (`~/.claude`), project, and task (`~/project/.claude`) using a dedicated `.claude` directory in the repository
