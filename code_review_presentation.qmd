...
:::
::: {.takeaway-title}
Ask a colleague to provide a code review
:::
::: {.takeaway-desc}
If you haven't already, ask a colleague to provide a code review and test out a pull request workflow on GitHub
:::
:::
